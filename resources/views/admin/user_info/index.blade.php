						...
						<div class="">
							<table class="table table-hover table-striped table-responsive">
								...
								<tr>
									...
									<td>
										<img width="300" height="200" src="{{$userinfo->national_id_image}}" alt="">
									</td>
								</tr>
								<tr>
									<th>
									...
									<td>
										<img width="300" height="200" src="{{$userinfo->driving_license_image}}" alt="">
									</td>
								</tr>
								<tr>
									<th>
							...
							<button type="button" class="btn btn-info editbtn" id="myBtn" data-toggle="modal" data-target="#myModal">
								UPDATE
								INFOMATION
							</button>
						</div>
							...
							<div class="form-row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<small id="helpId" class="text-muted">full
											name</small>
									</div>
									...
									<div class="form-group">
										...
										<small id="helpId" class="text-muted">10
											số</small>
									</div>
									...
									<div class="form-group">
										<label for="phone_emergency">phone
											emergency </label>
								...
								<div class="col-md-6">
									...
									<div class="form-group">
										<label for="national_id_image">national
											id
											image</label>
									...
									<div class="form-group">
										<label for="driving_license">driving
											license</label>
									...
									<div class="form-group">
										<label for="driving_license_image">driving
											license
											image</label>
